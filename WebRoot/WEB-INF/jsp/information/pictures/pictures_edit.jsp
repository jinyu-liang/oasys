							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td>
										...
										<c:if test="${pd != null && pd.PATH != '' && pd.PATH != null }">
											<a href="<%=basePath%>uploadFiles/uploadImgs/${pd.NAME}" target="_blank"><img src="<%=basePath%>uploadFiles/uploadImgs/${pd.NAME}" width="210"/></a>
											<input type="button" class="btn btn-mini btn-danger" value="删除" onclick="delP('${pd.PATH}','${pd.NAME }','${pd.PICTURES_ID }');" />
								...
								<tr>
									...
									<td><input type="text" name="BZ" id="BZ" value="${pd.BZ}" maxlength="100" style="width:95%;" placeholder="这里输入备注" title="备注"/></td>
								</tr>
								<tr>
...
<script type="text/javascript">
	...
	//删除图片
	function delP(PATH,NAME,PICTURES_ID){
		 if(confirm("确定要删除图片？")){
			var url = "pictures/deltp.do?PATH="+PATH+"&PICTURES_ID="+PICTURES_ID+"&NAME="+NAME+"&guid="+new Date().getTime();
