		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="hotelinfo/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="STAFF_ID" id="STAFF_ID" value="${pd.STAFF_ID}" maxlength="10" placeholder="这里输入工号*" title="工号" style="width:98%;" disabled/></td>
						    <!-- </tr>
						     <tr> -->
								<td style="width:75px;text-align: right;padding-top: 13px;">姓名:</td>
								<td><input type="text" name="STAFF_NAME" id="STAFF_NAME" value="${pd.STAFF_NAME}" maxlength="10" placeholder="这里输入姓名*" title="姓名" style="width:98%;" disabled/></td>
							</tr>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">	
							<tr>
								...
								<td><input type="text" name="HOTEL_NAME" id="HOTEL_NAME" value="${pd.HOTEL_NAME}" maxlength="20" placeholder="这里输入住宿地" title="住宿地" style="width:98%;" disabled/></td>
							<!-- </tr>
							<tr> -->
								<td style="width:75px;text-align: right;padding-top: 13px;">日单价:</td>
								<td><input type="text" name="HOTEL_DAY_PRICE" id="HOTEL_DAY_PRICE" value="${pd.HOTEL_DAY_PRICE}" maxlength="20" placeholder="这里输入日单价*" title="日单价" style="width:98%;" disabled/></td>
							</tr>
							...
							<tr>
								...
								<td><input type="text" name="HOTEL_ROOM_NU" id="HOTEL_ROOM_NU" value="${pd.HOTEL_ROOM_NU}" maxlength="20" placeholder="这里输入房号*" title="房号" style="width:98%;" disabled/></td>
							<!-- </tr>
							<tr> -->
								<td style="width:75px;text-align: right;padding-top: 13px;">在住人数:</td>
								<td><input type="text" name="HOTEL_LIVE_NU" id="HOTEL_LIVE_NU" value="${pd.HOTEL_LIVE_NU}" maxlength="10" placeholder="这里输入在住人数" title="在住人数" style="width:98%;" disabled/></td>
							</tr>
							</table>
							...
							<tr>
								...
								<td><input class="span10 date-picker" name="START_DATE" id="START_DATE" value="${pd.START_DATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="开始日期*" title="开始日期" style="width:98%;" disabled/></td>
							<!-- </tr>
							<tr> -->
								<td style="width:75px;text-align: right;padding-top: 13px;">结束日期:</td>
								<td><input class="span10 date-picker" name="END_DATE" id="END_DATE" value="${pd.END_DATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="结束日期" title="结束日期" style="width:98%;" disabled/></td>
							</tr>
							</table>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<td>
									<select class="chosen-select form-control" name="HOTEL_FLAG" id="HOTEL_FLAG" data-placeholder="请选择住宿类型" style="vertical-align:top;width: 130px;" disabled>
							...
							<td style="width:90px;text-align: right;padding-top: 13px;">床位信息:</td>
						         <td>
									...
									<select class="chosen-select form-control" name="HOTEL_BED_FLAG" id="HOTEL_BED_FLAG" data-placeholder="请选择局床位" style="vertical-align:top;width: 130px;" disabled>
							...
							<tr>
								...
								<td style="width:90px;text-align: right;padding-top: 13px;">是否有空床:</td>
									<td>
									<select class="chosen-select form-control" name="EMPTY_BED_FLAG" id="EMPTY_BED_FLAG" data-placeholder="是否有空床" style="vertical-align:top;width: 130px;" disabled>
							...
							<tr> -->
								...
								<td>
									<select class="chosen-select form-control" name="STATUS" id="STATUS" data-placeholder="住宿状态" style="vertical-align:top;width: 130px;" disabled>
							...
							<td>
							<textarea class="search_input" rows="3" cols="83" name="WORK_CONTENT" id="WORK_CONTENT"  placeholder="这里输入工作描述*"  style="color：gray;resize:none" disabled>${pd.WORK_CONTENT}</textarea>
							</td>
							</tr>
							</table>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">	
							<tr> 
								...
								<td>
							<textarea class="search_input" rows="3" cols="83" name="HOTEL_ADRESS" id="HOTEL_ADRESS"  placeholder="这里输入住宿详细地址*"  style="color：gray;resize:none" disabled>${pd.HOTEL_ADRESS}</textarea>
							</td>
							</tr>						
							</table>
<%-- 								<td style="width:75px;text-align: right;padding-top: 13px;">工作描述:</td>
							...
							<tr>
								...
								<td><input type="text" name="ROOMMATE" id="ROOMMATE" value="${pd.ROOMMATE}" maxlength="50" placeholder="这里输入同住人" title="同住人" style="width:98%;" disabled/></td>
							</tr>
							</table>
						<%-- 	<tr>
