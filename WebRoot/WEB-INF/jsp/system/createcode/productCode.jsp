...
<html lang="en">
	<head>
		...
		.commitbox_cen{}
		.commitbox_cen div.left{float:left;background-size:15px; background-position:0px 3px; padding-left:18px; color:#f77500; font-size:16px; }
		.commitbox_cen div.left img{width:30px;}
		.commitbox_cen div.right{float:right;}
...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
					...
					<input type="hidden" name="isPrimary" id="isPrimary" value="否" />
					<div id="dialog-add">
						        ...
						        <div class="commitbox_top">
						        	...
						        	<table>
						        		...
						        		<tr height="42px;">
						        			...
						        			<td style="padding-left: 16px;text-align: right;">主键：</td>
						        			<td style="padding-bottom: 5px;">
											<label style="float:left;padding-left: 20px;"><input name="form-field-radiop" id="form-field-radio6" onclick="isPrimary('是');" type="radio" value="icon-edit"><span class="lbl">是</span></label>
											<label style="float:left;padding-left: 20px;"><input name="form-field-radiop" id="form-field-radio7" onclick="isPrimary('否');" type="radio" value="icon-edit"><span class="lbl">否</span></label>
					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td><input type="text" name="tabletop" id="tabletop" value="${msg == 'add' ? 'TB_' : pd.TABLENAME}" placeholder="这里输入表名" style="width:156px" title="表名"/></td>
							</tr>
						</table>
...
<!-- /.main-container -->	
		...
		function reductionFields(){
			...
			if('edit' == msg){
				...
				var fieldarray = nowarField.split('Q');
