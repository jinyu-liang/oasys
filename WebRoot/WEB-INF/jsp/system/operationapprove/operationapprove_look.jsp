					...
					<form action="operationapprove/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="SUBMITID" id="SUBMITID" value="${pd.SUBMITID}" maxlength="50" placeholder="这里输入提交人ID" title="提交人ID" style="width:98%;" disabled/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">提交人:</td>
								<td><input type="text" name="SUBMITTER" id="SUBMITTER" value="${pd.SUBMITTER}" maxlength="20" placeholder="这里输入提交人" title="提交人" style="width:98%;" disabled/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">提交时间:</td>
								<td><input class="span10 date-picker" name="SUBMINT_DATE" id="SUBMINT_DATE" value="${pd.SUBMINT_DATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="提交时间" title="提交时间" style="width:98%;" disabled/></td>
							</tr>
							
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">更新人:</td>
								<td><input type="text" name="UPDATE_PEOPLE" id="UPDATE_PEOPLE" value="${pd.UPDATE_PEOPLE}" maxlength="20" placeholder="这里输入更新人" title="更新人" style="width:98%;" disabled/></td>
							</tr>
							
						    <tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">更新时间:</td>
								<td><input class="span10 date-picker" name="UPDATE_DATE" id="UPDATE_DATE" value="${pd.UPDATE_DATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="更新时间" title="更新时间" style="width:98%;" disabled/></td>
							</tr>
							...
							-->
							<td>
							<textarea class="search_input" rows="5" cols="55" name="QUES_DESCRIBE" id="QUES_DESCRIBE"  placeholder="这里输入问题描述"  style="resize:none" disabled>${pd.QUES_DESCRIBE}</textarea>
							</td>
							</tr>
							...
							-->
							<td>
							<textarea class="search_input" rows="5" cols="55" name="SOLUTION" id="SOLUTION"  placeholder="这里输入解决方案"  style="resize:none" disabled>${pd.SOLUTION}</textarea>
							</td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">风险评估:</td>
								<td><input type="text" name="RISK_ASSESS" id="RISK_ASSESS" value="${pd.RISK_ASSESS}" maxlength="100" placeholder="这里输入风险评估" title="风险评估" style="width:98%;" disabled/></td>
							</tr>
							...
							-->
							<td>
							<textarea  class="search_input" style="color:gray;resize:none" disabled rows="5" cols="55" name="UPDATE_CONTENT" id="UPDATE_CONTENT"  placeholder="这里输入更新内容" disabled >${pd.UPDATE_CONTENT}</textarea>
							</td>
							</tr>
							...
							<tr>
								...
								<td>
							<textarea class="search_input" rows="2" cols="55" name="UPDATE_STEP" id="UPDATE_STEP"  placeholder="这里输入更新步骤"  style="color：gray;resize:none" disabled >${pd.UPDATE_STEP}</textarea>
							</td>
							
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">验证方法:</td>
								<td><input type="text" name="TEST_METHOD" id="TEST_METHOD" value="${pd.TEST_METHOD}" maxlength="255" placeholder="这里输入验证方法" title="验证方法" style="width:98%;" disabled/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">局方主管:</td>
								<td><input type="text" name="OFFICE_SUPERVISOR" id="OFFICE_SUPERVISOR" value="${pd.OFFICE_SUPERVISOR}" maxlength="20" placeholder="这里输入局方主管" title="局方主管" style="width:98%;" disabled/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">局方经理:</td>
								<td><input type="text" name="OFFICE_MANAGER" id="OFFICE_MANAGER" value="${pd.OFFICE_MANAGER}" maxlength="20" placeholder="这里输入局方经理" title="局方经理" style="width:98%;" disabled/></td>
							</tr>
							<tr>
							...
							<!--  <select class="chosen-select form-control" name="APPROVE_STATE" id="APPROVE_STATE" data-placeholder="请选择局方审批状态" style="vertical-align:top;width: 120px;">
									...
									<select class="chosen-select form-control" name="APPROVE_STATE" id="APPROVE_STATE" data-placeholder="请选择局方审批状态" style="vertical-align:top;width: 130px;"disabled>
							...
							<tr>
								...
								<td><input type="text" name="APPROVE_SUGGES" id="APPROVE_SUGGES" value="${pd.APPROVE_SUGGES}" maxlength="255" placeholder="这里输入局方审批意见" title="局方审批意见" style="width:98%;" disabled/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">亚信主管:</td>
								<td><input type="text" name="ASI_OFFICE_SUPERVISOR" id="ASI_OFFICE_SUPERVISOR" value="${pd.ASI_OFFICE_SUPERVISOR}" maxlength="20" placeholder="这里输入亚信主管" title="亚信主管" style="width:98%;"disabled/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">亚信经理:</td>
								<td><input type="text" name="ASI_OFFICE_MANAGER" id="ASI_OFFICE_MANAGER" value="${pd.ASI_OFFICE_MANAGER}" maxlength="20" placeholder="这里输入亚信经理" title="亚信经理" style="width:98%;"disabled/></td>
							</tr>
							<tr>
							...
							-->
							<td>
								 	<select class="chosen-select form-control" name="ASI_APPROVE_STATE" id="ASI_APPROVE_STATE" data-placeholder="请选择亚信审批状态" style="vertical-align:top;width: 130px;"disabled>
							...
							<tr>
								...
								<td><input type="text" name="ASI_APPROVE_SUGGES" id="ASI_APPROVE_SUGGES" value="${pd.ASI_APPROVE_SUGGES}" maxlength="20" placeholder="这里输入亚信审批意见" title="亚信审批意见" style="width:98%;" disabled/></td>
							</tr>
						<!-- 	<tr>
