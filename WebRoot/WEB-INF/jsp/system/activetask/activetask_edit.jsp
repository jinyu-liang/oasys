					...
					<form action="activetask/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="TASK_NAME" id="TASK_NAME" value="${pd.TASK_NAME}" maxlength="255" placeholder="这里输入任务名称" title="任务名称" style="width:98%;" autocomplete="off"/></td>
							</tr>
							<tr>
								<td style="width:125px;text-align: right;padding-top: 13px;">需求编号:</td>
								<td><input type="text" name="TASK_CODE" id="TASK_CODE" value="${pd.TASK_CODE}" maxlength="255" placeholder="这里输入需求编号" title="需求编号" style="width:98%;" autocomplete="off"/></td>
							</tr>
							<tr>
								<td style="width:125px;text-align: right;padding-top: 13px;">任务类型:</td>
								<td>
								<select class="chosen-select form-control" name="TASK_TYPE" id="TASK_TYPE" data-placeholder="请选择任务类型" style="vertical-align:top;width: 300px;">
							...
							<tr>
								...
								<td><input class="span10 date-picker" name="START_DATE" id="START_DATE" value="${pd.START_DATE}" type="text" readonly="readonly" placeholder="实际开始时间" title="实际开始时间" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:125px;text-align: right;padding-top: 13px;">实际结束时间:</td>
								<td><input class="span10 date-picker" name="END_DATE" id="END_DATE" value="${pd.END_DATE}" type="text" readonly="readonly" placeholder="实际结束时间" title="实际结束时间" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:125px;text-align: right;padding-top: 13px;">实际工作量:</td>
								<td><input type="text" name="WORK_LOAD" id="WORK_LOAD" value="${pd.WORK_LOAD}" maxlength="255" placeholder="这里输入实际工作量" title="实际工作量" style="width:98%;" autocomplete="off"/></td>
							</tr>
<%-- 						
                            <tr>
...
--%>
							<tr>
								...
								title="具体工作内容" maxlength="255" placeholder="这里输入具体工作内容" autocomplete="off">${pd.REMARK}</textarea>
