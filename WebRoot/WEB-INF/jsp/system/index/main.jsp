			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">	
						<div id="jzts" style="display:none; width:100%; position: absolute; text-align: center; z-index:99999999; ">
						...
						<div style="margin:0 auto;width:100%;height:600px;">
							<iframe name="mainFrame" id="mainFrame" frameborder="0" src="tab.do" ></iframe>
						</div>
						</div><!-- /.row -->	
					</div><!-- /.page-content -->
