			...
			<form action="" method="post" name="loginForm"
				...
				<div class="form-actions">
					<div style="width:100%;padding-left:8%;">
						...
						<span class="pull-right" style="padding-right:12%;"><a href="javascript:quxiao();" class="btn btn-success">取消</a></span>
						<span class="pull-right" style="padding-left:3%;" ><a onclick="severCheck();" class="flip-link btn btn-info" id="to-recover">登录</a></span>
				...
				<div  style="style="float:left;padding-left:10%; margin-top:10px;">
					<font color="white">*[验证码]:只能输入数字和负号"-"</font> 
				</div>
				<div  style="style="float:left;padding-left:10%; margin-top:10px;">
	...
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			...
			<div data-src="static/login/images/banner_slide_03.jpg"></div>
			 -->
			<div data-src="static/login/images/banner_slide_06.png"></div>
			<div data-src="static/login/images/banner_slide_06.png"></div>
			<div data-src="static/login/images/banner_slide_06.png"></div>
		</div>
		<!-- #camera_wrap_3 -->
